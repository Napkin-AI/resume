...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Integrated sparse attention backends into SGLang Diffusion for Ascend NPU, including backend configuration, accuracy validation, documentation, and performance profiling.}
    \resumeItem{Implemented support for the mxfp8 Flash Attention backend and w8a8f8/w4a4f8 quantized Wan and Flux models.}
    \resumeItem{Investigated Qwen3 and diffusion-LLM prefill acceleration and inference bottlenecks on Ascend NPUs.}
    \resumeItem{The list of the PRs: \href{https://github.com/sgl-project/sglang/pulls?q=is\%3Apr+state\%3Aclosed+author\%3ANapkin-AI}{\underline{sgl-project/sglang/pulls}}.}
  \resumeItemListEnd
...
\section{Publications and conference participation}
\resumeSubHeadingListStart
  \resumeProjectHeading
