...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Интегрировал sparse attention backends в SGLang Diffusion для Ascend NPU, включая конфигурацию backend'ов, проверку точности, документацию и профилирование производительности; изменение принято в \href{https://github.com/sgl-project/sglang/pull/23482}{\underline{Pull Request \#23482}}.}
